...
// GET MAX ID
$q = "SELECT MAX(ID) AS MAX_ID FROM TAGIHAN WHERE NAMA = '$NAMA_ORANG'";
...
// GET ALL DATA
$q1 = "SELECT NAMA_KOST, ALAMAT_KOST, NO_TELEPON, EMAIL_KOST, WEBSITE_KOST, NAMA_PEMILIK, KETERANGAN, TOTAL_BAYAR FROM TAGIHAN WHERE NAMA = '$NAMA_ORANG' AND ID = '$MAX_ID' ";
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-6 col-sm-12 mb-4">
                    <h3>Create Receipt Payment | <?= $NAMA_ORANG ?></h3>
                        ...
                        <form action="proses.php" method="POST">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <input type="text" class="form-control" id="nama" name="nama" onkeyup="this.value = this.value.toUpperCase()" value="<?= $NAMA_ORANG ?>" readonly>
                                    </th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <input type="text" class="form-control" id="keterangan" name="keterangan" onkeyup="this.value = this.value.toUpperCase()" required>
                                    </th>
                                </tr>
                                <tr>
                                    <th></th>
                                    <th><button type="submit" name="tambahAda" class="btn btn-success"><i class="fas fa-plus-circle"></i> Add Receipt</button></th>
                                </tr>
                            </table>
                        </form>
                    </div>
