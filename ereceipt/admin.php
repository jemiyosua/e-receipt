                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['cari'])) {
                                ...
                                if ($cari == "") {
                                    $q = "SELECT DISTINCT a.ID, a.EMAIL, b.NAMA FROM LOGIN a, TAGIHAN b WHERE a.ID = b.ID_USER ORDER BY b.NAMA DESC LIMIT $limit_start, $limit";
                                    $sql = mysqli_query($conn, $q);
                                } else {
                                    $q = "SELECT DISTINCT a.ID, a.EMAIL, b.NAMA FROM LOGIN a, TAGIHAN b WHERE a.ID = b.ID_USER AND b.NAMA LIKE '%" . $cari . "%' ORDER BY b.NAMA DESC";
                                    $sql = mysqli_query($conn, $q);
                                }
                            } else {
                                $q = "SELECT DISTINCT a.ID, a.EMAIL, b.NAMA FROM LOGIN a, TAGIHAN b WHERE a.ID = b.ID_USER ORDER BY b.NAMA DESC LIMIT $limit_start, $limit";
                            ...
                            while ($row = mysqli_fetch_assoc($sql)) {
                                ...
                                // $q = "SELECT COUNT(*) AS CNT_RCVPYM FROM TAGIHAN WHERE ID_USER = $ID_USER_JOIN";
                                // $sql = mysqli_query($conn, $q);
                                // while ($row = mysqli_fetch_assoc($sql)) {

                                //     $TOTAL = $row['CNT_RCVPYM'];
                ...
                <nav aria-label="Page navigation example" style="padding-top: 30px;padding-left: 15px">
                    <ul class="pagination">
                        ...
                        if ($page == 1) { // Jika page adalah page ke 1, maka disable link PREV
                            ...
                            echo "<li class='page-item'><a class='page-link' href='admin.php?page=$link_prev'>&laquo;</a></li>";
                        }
                        ...
                        for ($i = $start_number; $i <= $end_number; $i++) {
                            ...
                            echo "<li$link_active><a class='page-link' href='admin.php?page=$i'>$i</a></li>";
                        }
                        ...
                        if ($page == $jumlah_page) { // Jika page terakhir
                            ...
                            echo "<li class='page-item'><a class='page-link' href='admin.php?page=$link_next'>&raquo;</a></li>";
