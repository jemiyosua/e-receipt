                    ...
                    <div class="table-responsive">
                        <form action="proses.php?id=<?= $ID_USER ?>" method="POST">
                            <table class="table">
                                ...
                                <tr>
                                    <th>NIK <i>(Nomor Induk Karyawan)</i> <text style="color:red">*</text></th>
                                    <th>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <input type="text" class="form-control" id="nama" name="nama" onkeyup="this.value = this.value.toUpperCase()" value="<?= $NAMA ?>" <?= $STATE ?> required/>
                                    </th>
                                </tr>
                                <tr>
                                    <th>Type of Electricity <i>(Jenis Listrik)</i> <text style="color:red">*</text></th>
                                    <th>
                                        <select class="form-control" name="jenislistrik" id="jenislistrik" required>
                                            <option selected>-</option>
                                            <option value ="T">Token</option>
                                            <option value ="NT">Non Token</option>
                                        </select>
                                    </th>
                                </tr>
                                <tr>
                                    <th>Electricity Number <i>(Nomor Meter / Id Pelanggan)</i> <text style="color:red">*</text></th>
                                    <th>
                                        <input type="text" class="form-control" id="nomormeter" name="nomormeter" required/>
                                    </th>
                                </tr>
                                <tr>
                                    <th>Electricity Customer Name <i>(Nama Pelanggan)</i> <text style="color:red">*</text></th>
                                    <th>
                                        <input type="text" class="form-control" id="namapelanggan" name="namapelanggan" onkeyup="this.value = this.value.toUpperCase()" required/>
                                    </th>
                                </tr>
                                <tr>
                                    <th>Boarding House Address <i>(Alamat Lengkap Kost)</i> <text style="color:red">*</text></th>
                                    <th>
                                ...
                                <tr>
                                    <th></th>
                                    <th><button type="submit" name="suratpernyataan" class="btn btn-success"><i class="fas fa-plus-circle"></i> Create Statement Letter</button></th>
                                </tr>
                            </table>
                        </form>
                    </div>
