        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item active">
                    <a href="index_admin.php"><i class="ik ik-bar-chart-2"></i><span>Dashboard</span></a>
                </div>
                <div class="nav-item active">
                    <a href="admin.php"><i class="fas fa-users"></i><span>User List</span></a>
                </div>
                <div class="nav-item active">
                    <a href="admin_statement_letter.php"><i class="fas fa-file-invoice"></i><span>Statement Letter</span></a>
                </div>
                <div class="nav-item active">
